...
public class BrandDatabase {
    ...
    private void initializeTestData() {
        ...
        Product product3 = new Product("Ultraboost Running Shoes", 159.99, "High-performance running shoes with Boost technology.");
        Product product4 = new Product("Essentials Hoodie", 49.99, "Comfortable hoodie for casual wear.");
        ...
        Product product6 = new Product("Designer Sunglasses", 249.99, "Luxury sunglasses with UV protection.");
        ...
        Product product7 = new Product("Running Sneakers", 89.99, "Comfortable running sneakers with excellent traction.");
        Product product8 = new Product("Essential Training Shorts", 29.99, "Training shorts for active lifestyles.");
...
// Brand 5: H&M
        ...
        Product product9 = new Product("Casual Dress", 39.99, "Stylish and affordable casual dress.");
        Product product10 = new Product("Slim-Fit Jeans", 29.99, "Slim-fit jeans for a modern look.");
...
// Brand 6: Zara
        ...
        Product product11 = new Product("Stylish Jacket", 79.99, "Trendy jacket for all occasions.");
        Product product12 = new Product("Denim Jeans", 39.99, "Classic denim jeans for everyday wear.");
...
// Brand 7: Levi's
        ...
        Product product13 = new Product("Classic 501 Jeans", 59.99, "Iconic 501 jeans for timeless style.");
        Product product14 = new Product("Trucker Jacket", 69.99, "Classic denim jacket for a rugged look.");
...
// Brand 8: Tommy Hilfiger
        ...
        Product product15 = new Product("Polo Shirt", 49.99, "Preppy polo shirt with the Tommy logo.");
        Product product16 = new Product("Chino Pants", 59.99, "Stylish chino pants for a classic look.");
...
// Brand 9: Calvin Klein
        ...
        Product product17 = new Product("Modern Fit Suit", 199.99, "Sleek and modern fit suit for special occasions.");
        Product product18 = new Product("Crew Neck T-Shirt", 24.99, "Essential crew neck t-shirt for everyday wear.");
        ...
        Product product19 = new Product("Classic Polo Shirt", 69.99, "Iconic polo shirt with the Ralph Lauren pony logo.");
        Product product20 = new Product("Cable Knit Sweater", 79.99, "Timeless cable knit sweater for a sophisticated look.");
...
// Brand 11: Versace
        ...
        Product product21 = new Product("Medusa Logo Shirt", 129.99, "Elegant shirt with the Versace Medusa logo.");
        Product product22 = new Product("Baroque Print Dress", 249.99, "Extravagant dress with Versace's iconic baroque print.");
...
// Brand 12: Armani
        ...
        Product product23 = new Product("Italian Wool Suit", 299.99, "High-quality wool suit for a timeless look.");
        Product product24 = new Product("Silk Necktie", 59.99, "Elegant silk necktie to complete your outfit.");
...
// Brand 13: Prada
        ...
        Product product25 = new Product("Saffiano Leather Bag", 399.99, "Luxurious Saffiano leather bag with Prada logo.");
        Product product26 = new Product("Cat-Eye Sunglasses", 179.99, "Stylish cat-eye sunglasses for a fashionable look.");
...
// Brand 14: Chanel
        ...
        Product product27 = new Product("Classic Flap Bag", 349.99, "Iconic Chanel flap bag for a sophisticated touch.");
        Product product28 = new Product("Chanel No. 5 Perfume", 79.99, "Timeless Chanel No. 5 perfume for a classic fragrance.");
...
// Brand 15: Burberry
        ...
        Product product29 = new Product("Burberry Check Scarf", 149.99, "Iconic Burberry check scarf for a stylish accessory.");
        Product product30 = new Product("Trench Coat", 299.99, "Timeless Burberry trench coat for all seasons.");
        ...
        Product product31 = new Product("Monogram Canvas Tote", 399.99, "Iconic Louis Vuitton monogram canvas tote.");
        Product product32 = new Product("LV Leather Belt", 159.99, "Luxurious Louis Vuitton leather belt with LV logo.");
...
// Brand 17: Dior
        ...
        Product product33 = new Product("Lady Dior Handbag", 599.99, "Elegant Lady Dior handbag with signature quilted pattern.");
        Product product34 = new Product("Sauvage Cologne", 89.99, "Signature Dior Sauvage cologne for men.");
...
// Brand 18: Balenciaga
        ...
        Product product35 = new Product("Speed Trainer Sneakers", 299.99, "Iconic Balenciaga Speed Trainer sneakers.");
        Product product36 = new Product("Oversized Logo T-Shirt", 129.99, "Oversized logo t-shirt for a bold look.");
...
// Brand 19: Alexander McQueen
        ...
        Product product37 = new Product("Skull Print Scarf", 149.99, "Signature Alexander McQueen skull print scarf.");
        Product product38 = new Product("Chunky Sneakers", 249.99, "Chunky sneakers for a unique and edgy style.");
...
// Brand 20: Fendi
        ...
        Product product39 = new Product("Fur Shoulder Bag", 499.99, "Elegant fur shoulder bag with Fendi logo.");
        Product product40 = new Product("FF Logo Belt", 199.99, "Stylish FF logo belt for a fashionable touch.");
